...
nnoremap <F5> :set spell! spelllang=en_us
...
set shortmess=aoO
badd +2 ~/.timebox/bucket_list.txt
badd +1 ~/.timebox/opportune.txt
badd +0 ~/.timebox/requisite.txt
badd +0 ~/.timebox/scratch.txt
args bucket_list.txt opportune.txt requisite.txt scratch.txt
edit ~/.timebox/scratch.txt
